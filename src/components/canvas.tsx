...
function Canvas (): React.JSX.Element {
    ...
    useEffect(() => {
        ...
        gradient.addColorStop( 0, '#FFC79D');
        gradient.addColorStop( 0.50, '#A7D4F7');
        gradient.addColorStop( 1, '#FFA1BD');
        ...
        return () => context.clearRect(0, 0, canvasPlotWidth, canvasPlotHeight);
